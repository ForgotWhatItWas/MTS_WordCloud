...
3. Структурное описание гита (что есть что в каком файле/директории, тут Фронт, тут бек - тут я очень утрировано, но думаю понятно)
4. Инструкция по развертке решения если оно локально и никуда не хост не загружено. 
